...
# Load 2024 data
data2024 <- read.csv("C:/Users/Dell/Documents/Honors Thesis/DRA/MP_Pres_2024.csv")
...
success_rates <- sapply(sizes, function(s) {
  test_bootstrap_size(data2024, s, B = 200)
})
...
plot(sizes, success_rates, type = "b",
     ...
     ylab = "Success Rate",
     main = "2024 EI Success Rate by Bootstrap Sample Size")
